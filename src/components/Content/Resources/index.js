  ...
  return (
    <animated.article className="resources" style={ fadeInContent }>
      <section className="resources__list">
        ...
        <div className="resources__item">
          The Anthropocene Atlas of Geneva (TAAG), <span className="resources__item--italic">Hannah Entwisle Chapuisat</span>.
          <br />
        ...
        <div className="resources__item">
          Global Protection Cluster, <span className="resources__item--italic">Protection in Natural Disasters</span>.
          <br />
        ...
        <div className="resources__item">
          International Federation of the Red Cross and Red Crescent Societies. <span className="resources__item--italic">The Cost of Doing Nothing: The Humanitarian Price of Climate Change and How It Can Be Avoided</span>, IFRC, 2019.
          <br />
        ...
        <div className="resources__item">
          International Organization for Migration, <span className="resources__item--italic">Migration, Environment and Climate Change (MECC) Division</span>.
          <br />
        ...
        <div className="resources__item">
          Lyons, Kate. <span className="resources__item--italic">Climate refugees can't be returned home, says landmark UN human rights ruling</span>, The guardian, 20 Jan. 2020.
          <br />
          <a href="https://www.knomad.org/"
            target="_blank"
            rel="noreferrer"
        ...
        <div className="resources__item">
          Martinez, Marta Rodriguez, and Lillo Montalto Monella. Extreme Weather Exiles: <span className="resources__item--italic">How Climate Change Is Making European Migrants,</span> Euronews, 17 June 2020.
          <br />
          <a
        ...
        <div className="resources__item">
          Mutter, John. <span className="resources__item--italic">The Disasters Profiteers. How Natural Disasters Make the Rich ­Richer and the Poor Even Poorer,</span> Palgrave Macmillan, 2015.
        </div>
        <div className="resources__item">
        ...
        <div className="resources__item">
          Rigaud, Kanta Kumari; de Sherbinin, Alex; Jones, Bryan; Bergmann, Jonas; Clement, Viviane; Ober, Kayly; Schewe, Jacob; Adamo, Susana; McCusker, Brent; Heuser, Silke; Midgley, Amelia. 2018. <span className="resources__item--italic">Groundswell : Preparing for Internal Climate Migration.</span> World Bank, Washington, DC.
          <br />
          <a
        ...
        <div className="resources__item">
          UNFCCC, <span className="resources__item--italic">Task Force on Displacement</span>.
          <br />
          <a
        ...
        <div className="resources__item">
          UN General Assembly, <span className="resources__item--italic">International Covenant on Civil and Political Rights</span>, 16 December 1966, United Nations, Treaty Series, vol. 999, p. 171.
          <br />
          <a
        ...
        <div className="resources__item">
          UN General Assembly, <span className="resources__item--italic">Universal Declaration of Human Rights</span>, 10 December 1948, 217 A (III).
          <br />
          <a
        ...
        <div className="resources__item">
          UNHCR, <span className="resources__item--italic">Climate Change and Disaster Displacement</span>.
          <br />
          <a
